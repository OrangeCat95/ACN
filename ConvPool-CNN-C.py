...
model.add(Convolution2D(192, 3, 3, border_mode = 'same', kernel_regularizer=regularizers.l2(0.001)))
model.add(Activation('relu'))
model.add(Convolution2D(192, 3, 3,border_mode='same', kernel_regularizer=regularizers.l2(0.001)))
model.add(Activation('relu'))
model.add(Convolution2D(192, 3, 3,border_mode='same', kernel_regularizer=regularizers.l2(0.001)))
...
model.add(Convolution2D(192, 3, 3, border_mode = 'same', kernel_regularizer=regularizers.l2(0.001)))
model.add(Activation('relu'))
model.add(Convolution2D(192, 1, 1,border_mode='valid', kernel_regularizer=regularizers.l2(0.001)))
model.add(Activation('relu'))
model.add(Convolution2D(10, 1, 1, border_mode='valid', kernel_regularizer=regularizers.l2(0.001)))
